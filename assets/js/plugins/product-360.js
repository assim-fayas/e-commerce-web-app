...
!function () {
  ...
  function b(b) {
    ...
    function r(a) {
      (c = !1),
        ...
        (i = !0),
        b.vertical
          ? (m.Y = a.clientY - d.offsetTop)
          : (m.X = a.clientX - d.offsetLeft);
    }
    ...
    function t(a) {
      if (i) {
        ...
        var c = b.vertical
          ? a.clientY - d.offsetTop - m.Y
          : a.clientX - d.offsetLeft - m.X;
        c = b.reverse ? -c : c;
        var e = h / f,
          g = l;
        (c = Math.floor(c / e)),
          c !== l &&
            ((l = s(m.frame + c)),
            g !== l &&
              ((d.getElementsByTagName("img")[g].style.display = "none"),
    ...
    function w() {
      if ((e && (e.style.display = "none"), 0 === k.length)) {
        ...
        if (
          ...
          (b.mouse || b.scroll) &&
            (p(d, "touchstart", r), p(d, "touchmove", t), p(d, "touchend", u));
        else if (
          (b.mouse &&
            (p(d, "mousedown", r),
            p(d, "mousemove", t),
    ...
    function y() {
      ...
      for (var b = 0; f > b; b++)
        (a = d.getElementsByTagName("img")[b]),
    ...
    var A = (this.turn = function (a) {
      (a = s(a)),
        ...
        (function d() {
          a !== l && c
            ? (z(s(l > a ? l - 1 : l + 1)),
              setTimeout(d, "undefined" == typeof a ? b.playSpeed : b.speed))
            : a === l &&
              ((m.frame = l = a),
              (c = !1),
              "function" == typeof n.change && n.change(l, f));
    ...
    (this.stop = function () {
      ...
      (this.set = function (c) {
        for (var e, d = 0; d < a.length; d++)
          (e = a[d]), (b[e] = "undefined" != typeof c[e] ? c[e] : b[e]);
      });
  }
  ...
  function c(a, c) {
    return (
      ...
      a.getAttribute("data-circlr")
        ? void 0
        : ((c = c || {}), (c.element = a), new b(c))
    );
  }
